...
import org.hyperskill.bankmanager.TransferFundsView
...
open class BankManagerUnitTest<T : Activity>(clazz: Class<T>) : AbstractUnitTest<T>(clazz) {
    ...
    inner class TransferFundsFromAccountView() {
        ...
        val transferFundsFromAccountEnterAmount: EditText by lazy {
            val view = activity.findViewByString<EditText>(
                "transferFundsFromAccountEnterAmount",
                "EditText enter amount at TransferFundsFromAccountView  was not found"
            )
        ...
        fun withdrawFundsFromAccount(withdrawAmount: Double = 0.0) {
            transferFundsFromAccountEnterAmount.append(withdrawAmount.toString())
        }
    ...
    fun withdraw(withdrawAmount: Double = 0.0) {
        ...
        val transferFundsView = TransferFundsView()
        transferFundsView.transferFundsFromAccountButton.clickAndRun().also {

            val transferFundsFromAccount = TransferFundsFromAccountView()
            transferFundsFromAccount.transferFundsFromAccountEnterAmount.append(withdrawAmount.toString())
            transferFundsFromAccount.withdrawFundsWithdrawButton.clickAndRun()
        }
    }
